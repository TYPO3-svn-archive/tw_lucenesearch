 ...
 */
class Tx_TwLucenesearch_ViewHelpers_Search_HighlightViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	/**
	 ...
	 * 
	 * @param Tx_Extbase_Configuration_ConfigurationManagerInterface $configurationManager		Configuration manager
	 * @return void
	 */
	...
	public function render($text = null, $search = null, $crop = null, $append = ' ...', $prepend = ' ... ', $field = 'bodytext') {
		...
		if (strlen($text)) {
			...
			} elseif ($search instanceof Tx_TwLucenesearch_Domain_Model_QueryHits) {
