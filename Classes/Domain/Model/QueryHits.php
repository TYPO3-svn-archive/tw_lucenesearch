 ...
 */
class Tx_TwLucenesearch_Domain_Model_QueryHits implements Tx_Extbase_Persistence_QueryResultInterface {
	/**
	 * Lucene index
	 * 
	...
	public function __construct(Zend_Search_Lucene_Interface $index, Zend_Search_Lucene_Search_Query $query, array $terms = array(), $highlight = false) {
		...
		foreach ($this->_index->find($this->_query) as $hit) {
			$this->_hits[]		= Tx_TwLucenesearch_Domain_Model_QueryHit::cast($hit);
		}
	 ...
	 * 
	 * @return Tx_TwLucenesearch_Domain_Model_QueryHits		Self reference
	 */
	 ...
	 * 
	 * @return Tx_TwLucenesearch_Domain_Model_QueryHit		First result
	 */
