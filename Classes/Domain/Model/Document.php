 ...
 */
class Tx_TwLucenesearch_Domain_Model_Document extends Zend_Search_Lucene_Document {
	 ...
	 * @return Tx_TwLucenesearch_Domain_Model_Document		Extended lucene document
	 */
